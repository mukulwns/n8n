...
export class SourceControlPreferences {
    ...
    @IsOptional() // tenantId is optional, adjust based on your requirements
    @IsUUID() // Validate that tenantId is a UUID
    ...
    static merge(
        ...
        return new SourceControlPreferences({
            ...
            tenantId: preferences.tenantId ?? defaultPreferences.tenantId, // Merge tenantId
        });
    }
}